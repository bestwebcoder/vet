...
const CATEGORIES = [
  { href: "/admin/reports/financial", label: "Financial", description: "Revenue, outstanding and paid invoices, by service and doctor.", icon: Receipt },
...
export default async function AdminReportsPage() {
  ...
  return (
    <div className="grid gap-6">
      ...
      <ReportAccessSettings doctors={doctorsResult.status === "ok" ? doctorsResult.data : []} />
    </div>
  );
}
